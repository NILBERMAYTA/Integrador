<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <a 
                href="{{ route('eventos.delete.index') }}" 
                wire:navigate 
                        ...
                        <tr class="hover:bg-[var(--color-surface-alt)] dark:hover:bg-[var(--color-surface-dark-alt)] transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2" x-data="{ modalIsOpen: false }">
                                    <a 
                                        href="{{ route('eventos.update', $evento) }}" 
                                        wire:navigate
                                    ...
                                    {{-- Modal de confirmación - mismo comportamiento que Categorías --}}
                                    ...
                                    >
                                        ...
                                        <p class="text-sm text-[var(--color-on-surface)] dark:text-[var(--color-on-surface-dark)] opacity-75">
                                            ...
                                            <br>
                                            Podrá restaurarlo posteriormente desde la lista de eventos eliminados.
                                        </p>
                                    </x-form.confirm-modal>
                                </div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-4 text-[var(--color-on-surface)] dark:text-[var(--color-on-surface-dark)] font-medium">No hay eventos registrados</p>
                                <p class="mt-1 text-sm text-[var(--color-on-surface)] dark:text-[var(--color-on-surface-dark)] opacity-60">Comienza creando un nuevo evento</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
