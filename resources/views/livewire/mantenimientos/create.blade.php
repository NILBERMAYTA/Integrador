<div class="w-full max-w-4xl mx-auto p-6">
  <form wire:submit.prevent="guardar" class="space-y-6 p-6 bg-surface dark:bg-surface-dark rounded-[var(--radius-radius)] shadow-md border border-outline dark:border-outline-dark">
    @csrf
    ...
    <div class="flex gap-3 pt-4 border-top border-outline dark:border-outline-dark">
      <x-form.button type="submit">Guardar</x-form.button>
